...
If you wish to contribute to Content Fuzzyfyr Module, please be sure to
...
If you have encountered a potential security vulnerability, please **DO NOT** report it on the public issue tracker: send it to us at [info@all-in-data.de](mailto:info@all-in-data.de) instead.
...
```console
$ git clone git@github.com:allin-data/magento2-content-fuzzyfyr.git
$ cd magento2-content-fuzzyfyr
```
...
```console
$ git remote add {username} git@github.com:{username}/magento2-content-fuzzyfyr.git
$ git fetch {username}
```

### Keeping Up-to-Date

Periodically, you should update your fork or personal repository to match the canonical Content Fuzzyfyr Module repository.
...
To ssh://git@github.com/{username}/magento2-content-fuzzyfyr.git
...
Navigate to your repository, select the branch you just created, and then select the "Pull Request" button in the upper right. Select the user/organization "allin-data" as the recipient.
